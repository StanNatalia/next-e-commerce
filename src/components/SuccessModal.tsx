...
const SuccessModal = ({ onClose, firstName, lastName }: SuccessModalProps) => {
  ...
  return (
    ...
    >
      ...
      <div
        className="bg-white relative rounded-xl w-full max-w-4xl h-[90vh] flex flex-col items-center justify-center text-center p-6 md:p-12 overflow-y-auto"
